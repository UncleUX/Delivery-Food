...
from restaurantMenu.models import menu, publicationPeriod
...
class TenantDataAndSettingsTest(BaseTestCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        settings.SHARED_APPS = ('django_tenants',  'accounts', 'core', 'drink', 'food',)
        settings.TENANT_APPS = ('django.contrib.contenttypes', 'restaurantFood', 'restaurantDrink', 'restaurantMenu', 'restaurantCommande', )
...
class BaseSyncTest(BaseTestCase):
    ...
    SHARED_APPS = ('django_tenants',  'accounts', 'core', 'drink', 'food',)
    TENANT_APPS = ('django.contrib.contenttypes', 'restaurantFood', 'restaurantDrink', 'restaurantMenu', 'restaurantCommande', )
